            ...
            function initialize() {
                aboutModel.append([
                    ...
                    { category: i18n.tr("Donations"),
                      mainText: "Liberapay",
                      secondaryText: i18n.tr("Support ubports"),
                      link: ""
                    }
                 ])
            }
